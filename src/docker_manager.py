        ...
        try:
            ...
            self.client.containers.run(
                ...
                environment={
                    ...
                    "EXECUTOR_REQUIRE_AUTH": os.getenv("EXECUTOR_REQUIRE_AUTH", "0"),
                    # ONLY skill-specific API keys — never inject LLM_API_KEY
                    # here because this container runs arbitrary bash/python/js
                    # commands generated by the LLM, which could leak env vars.
